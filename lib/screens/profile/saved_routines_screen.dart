  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: rp.isLoadingUserRoutines
          ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(theme.accentOrange)))
          : items.isEmpty
              ? Center(
                  child: Padding(
                    padding: const EdgeInsets.all(24),
                    child: Text(
                      widget.showFavoritesOnly ? 'No favorite routines yet.' : 'No saved routines yet.',
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.separated(
                    ...
                    separatorBuilder: (_, __) => Divider(color: theme.border.withValues(alpha: 0.4)),
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          icon: Icon(
                            ...
                            color: ur.isFavorite ? Colors.redAccent : theme.textSecondary,
                          ),
                          onPressed: () async {
                            await context.read<RoutineProvider>().toggleFavoriteByRoutineId(ur.routineId);
                          },
                        ),
